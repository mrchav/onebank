...
class Bank(models.Model):
    ...
    bank_fin_deposit = models.IntegerField(verbose_name='Вклады/депозиты')
    bank_fin_assets = models.IntegerField(verbose_name='активы')
    bank_fin_fiz_credit = models.IntegerField(verbose_name='Кредиты физ лицам')
    bank_fin_profit = models.IntegerField(verbose_name='Прибыль банка')
